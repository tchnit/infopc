...
int TFT_backlight_PIN = 25;


/* Encoder TFT Brightness*/ //Reserved!!! not supported on ESP32 Reserved
//volatile int brightness_count = 250; // Start Up PWM Brightness, moved to CFG!!!
int brightness_countLast      = 200;   // Store Last PWM Value
...
// pinMode(TFT_LED,OUTPUT); //Init led TFT LCD 
  ...
  analogWriteResolution(TFT_backlight_PIN, 220); //ESP32 only
#endif
